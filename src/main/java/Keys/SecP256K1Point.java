     ...
     public ECPoint add(ECPoint b) {
        ...
        else
        {
            ...
            int c1 = 0, w;
            {
				int i = 7, j = 16;
				do {
					long xVal = Z1.x[i--] & 0xFFFFFFFFL, p = xVal * xVal;
					a1[--j] = (c1 << 31) | (int) (p >>> 33);
					a1[--j] = (int) (p >>> 1);
					c1 = (int) p;
				} while (i > 0);
				long p = x_0 * x_0;
				zz_1 = (p >>> 33) | ((c1 << 31) & 0xFFFFFFFFL);
				a1[0] = (int) p;
				c1 = (int) (p >>> 32) & 1;
			}
        ...
        else
        {
            ...
            int c1 = 0, w;
            {
				int i = 7, j = 16;
				do {
					long xVal = Z2.x[i--] & 0xFFFFFFFFL, p = xVal * xVal;
					a1[--j] = (c1 << 31) | (int) (p >>> 33);
					a1[--j] = (int) (p >>> 1);
					c1 = (int) p;
				} while (i > 0);
         ...
         int c2 = 0, w1;
         {
			int i1 = 7, j1 = 16;
			do {
				long xVal1 = H[i1--] & 0xFFFFFFFFL, p1 = xVal1 * xVal1;
				a11[--j1] = (c2 << 31) | (int) (p1 >>> 33);
				a11[--j1] = (int) (p1 >>> 1);
				c2 = (int) p1;
			} while (i1 > 0);
			long p1 = x_01 * x_01;
			zz_15 = (p1 >>> 33) | ((c2 << 31) & 0xFFFFFFFFL);
			a11[0] = (int) p1;
			c2 = (int) (p1 >>> 32) & 1;
		}
        ...
        SecP256K1FieldElement X3 = new SecP256K1FieldElement(t4);
         ...
         int c1 = 0, w;
         {
			int i = 7, j = 16;
			do {
				long xVal = t2[i--] & 0xFFFFFFFFL, p = xVal * xVal;
				a1[--j] = (c1 << 31) | (int) (p >>> 33);
				a1[--j] = (int) (p >>> 1);
				c1 = (int) p;
			} while (i > 0);
        ...
        {
            int[] a2 = new int[16];
            long y_0 = Z1.x[0] & 0xFFFFFFFFL, y_1 = Z1.x[1] & 0xFFFFFFFFL;
            long y_2 = Z1.x[2] & 0xFFFFFFFFL, y_3 = Z1.x[3] & 0xFFFFFFFFL;
            long y_4 = Z1.x[4] & 0xFFFFFFFFL, y_5 = Z1.x[5] & 0xFFFFFFFFL;
            long y_6 = Z1.x[6] & 0xFFFFFFFFL, y_7 = Z1.x[7] & 0xFFFFFFFFL;
        ...
        {
            int[] a2 = new int[16];
            long y_0 = Z2.x[0] & 0xFFFFFFFFL, y_1 = Z2.x[1] & 0xFFFFFFFFL, y_2 = Z2.x[2] & 0xFFFFFFFFL,
					y_3 = Z2.x[3] & 0xFFFFFFFFL;
            long y_4 = Z2.x[4] & 0xFFFFFFFFL, y_5 = Z2.x[5] & 0xFFFFFFFFL, y_6 = Z2.x[6] & 0xFFFFFFFFL,
					y_7 = Z2.x[7] & 0xFFFFFFFFL;
            long c3 = 0, x_02 = Z3.x[0] & 0xFFFFFFFFL;
                c3 += y_0 * x_02;
                a2[0] = (int) c3;
                c3 >>>= 32;
   ...
   protected ECPoint twice()
    {
        ...
        int i3 = 7, j3 = 16;
		do {
			long xVal3 = Y1.x[i3--] & 0xFFFFFFFFL, p3 = xVal3 * xVal3;
			a13[--j3] = (c4 << 31) | (int) (p3 >>> 33);
			a13[--j3] = (int) (p3 >>> 1);
			c4 = (int) p3;
		} while (i3 > 0);
		long p3 = x_03 * x_03;
		zz_17 = (p3 >>> 33) | ((c4 << 31) & 0xFFFFFFFFL);
		a13[0] = (int) p3;
		c4 = (int) (p3 >>> 32) & 1;
        ...
        zz_53 &= 0xFFFFFFFFL;
            ...
            a13[3] = c4 | (w3 << 1);
            c4 = w3 >>> 31;
            zz_43 += x_13 * x_33 + (zz_33 >>> 32);
            zz_53 += x_23 * x_33 + (zz_43 >>> 32);
            zz_43 &= 0xFFFFFFFFL;
            zz_63 += zz_53 >>> 32;
            zz_53 &= 0xFFFFFFFFL;
        ...
        zz_73 &= 0xFFFFFFFFL;
            ...
            a13[4] = c4 | (w3 << 1);
            c4 = w3 >>> 31;
            zz_53 += x_13 * x_43 + (zz_43 >>> 32);
            zz_63 += x_23 * x_43 + (zz_53 >>> 32);
            zz_53 &= 0xFFFFFFFFL;
            zz_73 += x_33 * x_43 + (zz_63 >>> 32);
            zz_63 &= 0xFFFFFFFFL;
            zz_83 += zz_73 >>> 32;
            zz_73 &= 0xFFFFFFFFL;
        ...
        zz_93 &= 0xFFFFFFFFL;
            ...
            a13[5] = c4 | (w3 << 1);
            c4 = w3 >>> 31;
            zz_63 += x_13 * x_53 + (zz_53 >>> 32);
            zz_73 += x_23 * x_53 + (zz_63 >>> 32);
            zz_63 &= 0xFFFFFFFFL;
            zz_83 += x_33 * x_53 + (zz_73 >>> 32);
            zz_73 &= 0xFFFFFFFFL;
            zz_93 += x_43 * x_53 + (zz_83 >>> 32);
            zz_83 &= 0xFFFFFFFFL;
            zz_103 += zz_93 >>> 32;
            zz_93 &= 0xFFFFFFFFL;
        ...
        zz_113 &= 0xFFFFFFFFL;
            ...
            a13[6] = c4 | (w3 << 1);
            c4 = w3 >>> 31;
            zz_73 += x_13 * x_63 + (zz_63 >>> 32);
            zz_83 += x_23 * x_63 + (zz_73 >>> 32);
            zz_73 &= 0xFFFFFFFFL;
            zz_93 += x_33 * x_63 + (zz_83 >>> 32);
            zz_83 &= 0xFFFFFFFFL;
            zz_103 += x_43 * x_63 + (zz_93 >>> 32);
            zz_93 &= 0xFFFFFFFFL;
            zz_113 += x_53 * x_63 + (zz_103 >>> 32);
            zz_103 &= 0xFFFFFFFFL;
            zz_123 += zz_113 >>> 32;
            zz_113 &= 0xFFFFFFFFL;
        ...
        zz_133 &= 0xFFFFFFFFL;
            ...
            a13[7] = c4 | (w3 << 1);
            c4 = w3 >>> 31;
            zz_83 += x_13 * x_73 + (zz_73 >>> 32);
            zz_93 += x_23 * x_73 + (zz_83 >>> 32);
            zz_103 += x_33 * x_73 + (zz_93 >>> 32);
            zz_113 += x_43 * x_73 + (zz_103 >>> 32);
            zz_123 += x_53 * x_73 + (zz_113 >>> 32);
            zz_133 += x_63 * x_73 + (zz_123 >>> 32);
            zz_143 += zz_133 >>> 32;
        ...
        int c3 = 0, w2;
        {
			int i2 = 7, j2 = 16;
			do {
				long xVal2 = Y1Squared[i2--] & 0xFFFFFFFFL, p2 = xVal2 * xVal2;
				a12[--j2] = (c3 << 31) | (int) (p2 >>> 33);
				a12[--j2] = (int) (p2 >>> 1);
				c3 = (int) p2;
			} while (i2 > 0);
			long p2 = x_02 * x_02;
			zz_16 = (p2 >>> 33) | ((c3 << 31) & 0xFFFFFFFFL);
			a12[0] = (int) p2;
			c3 = (int) (p2 >>> 32) & 1;
		}
        ...
        zz_52 &= 0xFFFFFFFFL;
            ...
            a12[3] = c3 | (w2 << 1);
            c3 = w2 >>> 31;
            zz_42 += x_12 * x_32 + (zz_32 >>> 32);
            zz_52 += x_22 * x_32 + (zz_42 >>> 32);
            zz_42 &= 0xFFFFFFFFL;
            zz_62 += zz_52 >>> 32;
            zz_52 &= 0xFFFFFFFFL;
		...
		int[] a2 = new int[16];
		long y_0 = Z1.x[0] & 0xFFFFFFFFL, y_1 = Z1.x[1] & 0xFFFFFFFFL, y_2 = Z1.x[2] & 0xFFFFFFFFL,
				y_3 = Z1.x[3] & 0xFFFFFFFFL, y_4 = Z1.x[4] & 0xFFFFFFFFL, y_5 = Z1.x[5] & 0xFFFFFFFFL,
				y_6 = Z1.x[6] & 0xFFFFFFFFL, y_7 = Z1.x[7] & 0xFFFFFFFFL;
		extracted(Z3, a2, y_0, y_1, y_2, y_3, y_4, y_5, y_6, y_7);
		for (int i = 1; i < 8; ++i) {
	...
	private void extracted(SecP256K1FieldElement Z3, int[] a2, long y_0, long y_1, long y_2, long y_3, long y_4,
			long y_5, long y_6, long y_7) {
    ...
    public ECPoint twicePlus(ECPoint b) {
		return x == null || y == null || (zs.length > 0 && zs[0].toBigInteger().signum() == 0) ? b : twice().add(b);
	}
