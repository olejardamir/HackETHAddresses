class FixedPointUtil {
    final private static String PRECOMP_NAME = "bc_fixed_point";
    
    FixedPointUtil() {
    }
    
    public static int getCombSize(ECCurve a) {
        java.math.BigInteger a0 = a.getOrder();
        return (a0 != null) ? a0.bitLength() : a.getFieldSize() + 1;
    }
    ...
    public static FixedPointPreCompInfo precompute(ECPoint arg) {/*error*/throw null;}
}
