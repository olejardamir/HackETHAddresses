class ASN1InputStream extends java.io.FilterInputStream {
    ...
    final public static int NULL = 5;
    final public static int OBJECT_IDENTIFIER = 6;
    final public static int EXTERNAL = 8;
    final public static int SEQUENCE = 16;
    final private static int SET = 17;
    final public static int CONSTRUCTED = 32;
    final private static int APPLICATION = 64;
    final private static int TAGGED = 128;
    final private int limit;
    final private boolean lazyEvaluate;
    
    private ASN1InputStream(java.io.InputStream a) {
        this(a, StreamUtil.findLimit(a));
    }
    
    public ASN1InputStream(byte[] a) {
        this((java.io.InputStream)new java.io.ByteArrayInputStream(a), a.length);
    }
    
    public ASN1InputStream(byte[] a, boolean b) {
        this((java.io.InputStream)new java.io.ByteArrayInputStream(a), a.length, b);
    }
    
    private ASN1InputStream(java.io.InputStream a, int i) {
        this(a, i, false);
    }
    ...
    private ASN1InputStream(java.io.InputStream arg, int arg0, boolean arg1) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private int readLength() {/*error*/throw null;}
    ...
    private ASN1Primitive buildObject(int arg, int arg0, int arg1) {/*error*/throw null;}
    
    
    private ASN1EncodableVector buildEncodableVector() {
        ASN1EncodableVector a = new ASN1EncodableVector();
        while(true) {
            ASN1Primitive a0 = this.readObject();
            if (a0 == null) {
                return a;
            }
            a.add((ASN1Encodable)(Object)a0);
        }
    }
    
    private ASN1EncodableVector buildDEREncodableVector(DefiniteLengthInputStream a) {
        return new ASN1InputStream((java.io.InputStream)a).buildEncodableVector();
    }
    ...
    public ASN1Primitive readObject() {
        ...
        int i0 = ASN1InputStream.readTagNumber((java.io.InputStream)this, i);
        if ((i & 32) != 0) {
        }
        int i1 = this.readLength();
        if (i1 >= 0) {
            return this.buildObject(i, i0, i1);
        }
        if ((i & 64) != 0) {
            ASN1Primitive a0 = null;
            return a0;
        }
        if ((i & 128) == 0) {
            ASN1Primitive a1 = null;
            return a1;
        }
        ASN1Primitive a2 = null;
        return a2;
    }
    
    private static int readTagNumber(java.io.InputStream a, int i) {
        int i0 = i & 31;
        if (i0 == 31) {
            int i1 = a.read();
            int i2 = 0;
    ...
    private static int readLength(java.io.InputStream a, int i) {
        int i0 = a.read();
        if (i0 == 128) {
            return -1;
        }
