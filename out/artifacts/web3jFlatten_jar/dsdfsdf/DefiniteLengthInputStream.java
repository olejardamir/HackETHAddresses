class DefiniteLengthInputStream extends LimitedInputStream {
    final private static byte[] EMPTY_BYTES;
    final private int _originalLength;
    ...
    DefiniteLengthInputStream(int arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    int getRemaining() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    byte[] toByteArray() {/*error*/throw null;}
