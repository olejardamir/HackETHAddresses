class ECAlgorithms {
    ...
    public static boolean isFpCurve(ECCurve a) {
        return ECAlgorithms.isFpField(a.getField());
    }
    
    private static boolean isFpField(FiniteField a) {
        return a.getDimension() == 1;
    }
    
    public static ECPoint importPoint(ECCurve a, ECPoint a0) {
        if (!a.equals(a0.getCurve())) {
            throw new IllegalArgumentException((String)None);
        }
        return a.importPoint(a0);
    }
    ...
    public static void montgomeryTrick(ECFieldElement[] arg, int arg0, int arg1, ECFieldElement arg2) {/*error*/throw null;}
    
    
    static ECPoint implCheckResult(ECPoint a) {
        if (!a.isValidPartial()) {
