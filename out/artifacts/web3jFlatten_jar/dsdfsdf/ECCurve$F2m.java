public class ECCurve$F2m extends ECCurve$AbstractF2m {
    final private static int F2M_DEFAULT_COORDS = 6;
    final private int m;
    final private int k1;
    final private int k2;
    final private int k3;
    final private ECPoint$F2m infinity;
    
    public ECCurve$F2m(int i, int i0, java.math.BigInteger a, java.math.BigInteger a0) {
        this(i, i0, 0, 0, a, a0, (java.math.BigInteger)null);
    }
    
    public ECCurve$F2m(int i, int i0, int i1, int i2, java.math.BigInteger a, java.math.BigInteger a0) {
        this(i, i0, i1, i2, a, a0, (java.math.BigInteger)null);
    }
    ...
    ECCurve$F2m(int arg, int arg0, int arg1, int arg2, java.math.BigInteger arg3, java.math.BigInteger arg4, java.math.BigInteger arg5) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ECCurve$F2m(int arg, int arg0, int arg1, int arg2, ECFieldElement arg3, ECFieldElement arg4, java.math.BigInteger arg5, java.math.BigInteger arg6) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    boolean isTrinomial() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    static int access$100(ECCurve$F2m arg) {/*error*/throw null;}
}
