class DERSequence extends ASN1Sequence {
    ...
    public DERSequence() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public DERSequence(ASN1EncodableVector arg) {/*error*/throw null;}
    ...
    int encodedLength() {
        return 1 + StreamUtil.calculateBodyLength(this.getBodyLength()) + this.getBodyLength();
    }
    
    void encode(ASN1OutputStream a) {
        a.write(48);
        a.writeLength(this.getBodyLength());
        Object a0 = this.getObjects();
        while(((java.util.Enumeration)a0).hasMoreElements()) {
            a.getDERSubStream().writeObject((ASN1Encodable)((java.util.Enumeration)a0).nextElement());
        }
    }
}
