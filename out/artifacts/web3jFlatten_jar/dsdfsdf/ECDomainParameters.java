class ECDomainParameters implements ECConstants {
    ...
    public ECDomainParameters(ECCurve arg, ECPoint arg0, java.math.BigInteger arg1, java.math.BigInteger arg2) {/*error*/throw null;}
    ...
    private static ECPoint validate(ECCurve a, ECPoint a0) {
        if (a0 == null) {
            throw new IllegalArgumentException((String)None);
        }
        ECPoint a1 = ECAlgorithms.importPoint(a, a0).normalize();
        if (a1.isInfinity()) {
            throw new IllegalArgumentException((String)None);
        }
        if (a1.isValid()) {
