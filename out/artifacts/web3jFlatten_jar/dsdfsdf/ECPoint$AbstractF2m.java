abstract public class ECPoint$AbstractF2m extends ECPoint {
    ECPoint$AbstractF2m(ECCurve a, ECFieldElement a0, ECFieldElement a1) {
        super(a, a0, a1);
    }
    
    ECPoint$AbstractF2m(ECCurve a, ECFieldElement a0, ECFieldElement a1, ECFieldElement[] a2) {
        super(a, a0, a1, a2);
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint scaleX(ECFieldElement arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint scaleY(ECFieldElement arg) {/*error*/throw null;}
