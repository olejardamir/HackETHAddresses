public class Curve25519FieldElement extends ECFieldElement$AbstractFp {
    final private static java.math.BigInteger Q;
    final private static int[] PRECOMP_POW2;
    int[] x;
    ...
    public Curve25519FieldElement(java.math.BigInteger arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public Curve25519FieldElement() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    Curve25519FieldElement(int[] arg) {/*error*/throw null;}
