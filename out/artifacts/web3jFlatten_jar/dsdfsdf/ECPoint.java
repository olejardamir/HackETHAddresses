abstract public class ECPoint {
    ...
    private static ECFieldElement[] getInitialZCoords(ECCurve a) {
        int i = (null != a) ? a.getCoordinateSystem() : 0;
        switch(i) {
            case 0: case 5: {
                return EMPTY_ZS;
            }
            default: {
                ECFieldElement a0 = a.fromBigInteger(ECConstants.ONE);
                switch(i) {
                    case 4: {
                        ECFieldElement[] a1 = new ECFieldElement[2];
                        a1[0] = a0;
                        a1[1] = a.getA();
                        return a1;
                    }
                    case 3: {
                        ECFieldElement[] a2 = new ECFieldElement[3];
                        a2[0] = a0;
                        a2[1] = a0;
                        a2[2] = a0;
                        return a2;
                    ...
                    case 1: case 2: case 6: {
                        ECFieldElement[] a3 = new ECFieldElement[1];
                        a3[0] = a0;
                        return a3;
                    }
                    default: {
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    final ECFieldElement[] getRawZCoords() {/*error*/throw null;}
    ...
    public ECPoint normalize() {
        ...
        switch(this.getCurveCoordinateSystem()) {
            ...
            default: {
                ECFieldElement a = this.getZCoord(0);
                if (a.isOne()) {
                    return this;
                }
                return this.normalize(a.invert());
            }
        }
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public boolean isCompressed() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ECPoint scaleX(ECFieldElement arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ECPoint scaleY(ECFieldElement arg) {/*error*/throw null;}
    
    
    public boolean equals(ECPoint a) {
        boolean b = false;
        if (null == a) {
            return false;
        }
        ECCurve a0 = this.getCurve();
        ECCurve a1 = a.getCurve();
        boolean b0 = null == a0;
        boolean b1 = null == a1;
        boolean b2 = this.isInfinity();
        boolean b3 = a.isInfinity();
        if (!b2 && !b3) {
            ECPoint a2 = null;
            boolean b4 = false;
            label7: {
                ...
                if (b0) {
                    ...
                    ECPoint[] a4 = new ECPoint[2];
                    a4[0] = this;
                    a4[1] = a0.importPoint(a);
                    a0.normalizeAll(a4);
                    a2 = a4[0];
                    a = a4[1];
                }
            }
            boolean b5 = ((Object)a2.getXCoord()).equals((Object)a.getXCoord());
            label5: {
                label3: {
                    label4: {
                        if (!b5) {
                        ...
                        if (((Object)a2.getYCoord()).equals((Object)a.getYCoord())) {
                            break label3;
                        }
                    }
                    b4 = false;
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public byte[] getEncoded() {/*error*/throw null;}
