abstract public class ASN1External extends ASN1Primitive {
    ...
    ASN1External(ASN1EncodableVector arg) {/*error*/throw null;}
    
    
    private ASN1Primitive getObjFromVector(ASN1EncodableVector a, int i) {
        return a.get(i).toASN1Primitive();
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private void setEncoding(int arg) {/*error*/throw null;}
}
