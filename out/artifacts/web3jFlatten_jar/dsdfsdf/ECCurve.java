abstract public class ECCurve {
    final public static int COORD_AFFINE = 0;
    final public static int COORD_HOMOGENEOUS = 1;
    final public static int COORD_JACOBIAN = 2;
    final public static int COORD_JACOBIAN_CHUDNOVSKY = 3;
    final public static int COORD_JACOBIAN_MODIFIED = 4;
    final public static int COORD_LAMBDA_AFFINE = 5;
    final public static int COORD_LAMBDA_PROJECTIVE = 6;
    final private FiniteField field;
    ECFieldElement a;
    ECFieldElement b;
    ...
    ECCurve(FiniteField arg) {/*error*/throw null;}
    
    
    abstract public int getFieldSize();
    
    
    abstract public ECFieldElement fromBigInteger(java.math.BigInteger arg);
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public synchronized ECCurve$Config configure() {/*error*/throw null;}
    
    
    private ECPoint validatePoint(java.math.BigInteger a0, java.math.BigInteger a1) {
        ECPoint a2 = this.createPoint(a0, a1);
        if (a2.isValid()) {
    ...
    public ECPoint validatePoint(java.math.BigInteger a0, java.math.BigInteger a1, boolean b0) {
        ECPoint a2 = this.createPoint(a0, a1, b0);
        if (a2.isValid()) {
            throw new IllegalArgumentException((String)None);
        }
        return a2;
    ...
    private ECPoint createPoint(java.math.BigInteger a0, java.math.BigInteger a1) {
        return this.createPoint(a0, a1, false);
    }
    
    public ECPoint createPoint(java.math.BigInteger a0, java.math.BigInteger a1, boolean b0) {
        return this.createRawPoint(this.fromBigInteger(a0), this.fromBigInteger(a1), b0);
    }
    
    abstract protected ECCurve cloneCurve();
    
    
    abstract protected ECPoint createRawPoint(ECFieldElement arg, ECFieldElement arg0, boolean arg1);
    
    
    abstract protected ECPoint createRawPoint(ECFieldElement arg, ECFieldElement arg0, ECFieldElement[] arg1, boolean arg2);
    
    
    boolean supportsCoordinateSystem(int i) {
        return i == 0;
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public PreCompInfo precompute(ECPoint arg, String arg0, PreCompCallback arg1) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint importPoint(ECPoint arg) {/*error*/throw null;}
    
    
    public void normalizeAll(ECPoint[] a0) {
        this.normalizeAll(a0, 0, a0.length, (ECFieldElement)null);
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private void normalizeAll(ECPoint[] arg, int arg0, int arg1, ECFieldElement arg2) {/*error*/throw null;}
    
    
    abstract public ECPoint getInfinity();
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public FiniteField getField() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECFieldElement getA() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECFieldElement getB() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public java.math.BigInteger getOrder() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public java.math.BigInteger getCofactor() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public int getCoordinateSystem() {/*error*/throw null;}
    
    
    abstract protected ECPoint decompressPoint(int arg, java.math.BigInteger arg0);
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint decodePoint(byte[] arg) {/*error*/throw null;}
    ...
    private void checkPoint(ECPoint a0) {
        if (null != a0 && this == a0.getCurve()) {
            return;
        }
        throw new IllegalArgumentException((String)None);
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private void checkPoints(ECPoint[] arg, int arg0, int arg1) {/*error*/throw null;}
    
    
    public boolean equals(ECCurve a0) {
        boolean b0 = false;
        label2: {
            label0: {
                if (this == a0) {
                ...
                label1: {
                    ...
                    if (!((Object)this.getField()).equals((Object)a0.getField())) {
                        break label1;
                    }
                    if (!this.getA().toBigInteger().equals((Object)a0.getA().toBigInteger())) {
                        break label1;
                    }
                    if (this.getB().toBigInteger().equals((Object)a0.getB().toBigInteger())) {
                        break label0;
                    }
                }
                b0 = false;
    ...
    public int hashCode() {
        return ((Object)this.getField()).hashCode() ^ Integers.rotateLeft(this.getA().toBigInteger().hashCode(), 8) ^ Integers.rotateLeft(this.getB().toBigInteger().hashCode(), 16);
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    static AbstractECMultiplier access$002(ECCurve arg, AbstractECMultiplier arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    static AbstractECMultiplier access$000(ECCurve arg) {/*error*/throw null;}
}
