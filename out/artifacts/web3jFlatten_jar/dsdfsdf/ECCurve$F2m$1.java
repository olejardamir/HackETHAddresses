class ECCurve$F2m$1 implements ECLookupTable {
    final int val$len;
    final int val$FE_LONGS;
    final long[] val$table;
    final int[] val$ks;
    final ECCurve$F2m this$0;
    ...
    ECCurve$F2m$1(ECCurve$F2m arg, int arg0, int arg1, long[] arg2, int[] arg3) {/*error*/throw null;}
