public class ECPoint$Fp extends ECPoint$AbstractFp {
    ...
    public ECPoint$Fp(ECCurve arg, ECFieldElement arg0, ECFieldElement arg1, boolean arg2) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ECPoint$Fp(ECCurve arg, ECFieldElement arg0, ECFieldElement arg1, ECFieldElement[] arg2, boolean arg3) {/*error*/throw null;}
    
    
    public ECFieldElement getZCoord(int i) {
        if (i == 1 && 4 == this.getCurveCoordinateSystem()) {
            return this.getJacobianModifiedW();
        }
        return ((ECPoint$AbstractFp)this).getZCoord(i);
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint add(ECPoint arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint twice() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint twicePlus(ECPoint arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint threeTimes() {/*error*/throw null;}
    ...
    ECFieldElement two(ECFieldElement a) {
        return a.add(a);
    }
    
    ECFieldElement three(ECFieldElement a) {
        return this.two(a).add(a);
    }
    
    ECFieldElement four(ECFieldElement a) {
        return this.two(this.two(a));
    }
    
    ECFieldElement eight(ECFieldElement a) {
        return this.four(this.two(a));
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ECPoint negate() {/*error*/throw null;}
    
    
    ECFieldElement calculateJacobianModifiedW(ECFieldElement a, ECFieldElement a0) {
        ECFieldElement a1 = this.getCurve().getA();
        if (!a1.isZero() && !a.isOne()) {
            if (a0 == null) {
                a0 = a.square();
            }
            ECFieldElement a2 = a0.square();
            ECFieldElement a3 = a1.negate();
            return (a3.bitLength() >= a1.bitLength()) ? a2.multiply(a1) : a2.multiply(a3).negate();
        }
        return a1;
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ECFieldElement getJacobianModifiedW() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ECPoint$Fp twiceJacobianModified(boolean arg) {/*error*/throw null;}
}
