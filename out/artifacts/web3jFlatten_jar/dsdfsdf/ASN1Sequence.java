abstract public class ASN1Sequence extends ASN1Primitive {
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private ASN1Encodable[] toArray() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private ASN1Encodable getObjectAt(int arg) {/*error*/throw null;}
    ...
    public int hashCode() {
        ...
        while(((java.util.Enumeration)a0).hasMoreElements()) {
            i = i * 17 ^ ((Object)this.getNext((java.util.Enumeration)a0)).hashCode();
        }
        return i;
    }
    ...
    private ASN1Encodable getNext(java.util.Enumeration a) {
        return (ASN1Encodable)a.nextElement();
    }
    ...
    public java.util.Iterator iterator() {
        return (java.util.Iterator)(Object)new Arrays$Iterator((Object[])this.toArray());
    }
}
