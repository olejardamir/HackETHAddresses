abstract public class ASN1Set extends ASN1Primitive {
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ASN1Set(ASN1EncodableVector arg) {/*error*/throw null;}
    ...
    private ASN1Encodable getNext(java.util.Enumeration a) {
        ...
        if (a0 != null) {
            return (ASN1Encodable)a0;
        }
        return (ASN1Encodable)(Object)DERNull.INSTANCE;
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private boolean lessThanOrEqual(byte[] arg, byte[] arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private byte[] getDEREncoded(ASN1Encodable arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private void sort() {/*error*/throw null;}
