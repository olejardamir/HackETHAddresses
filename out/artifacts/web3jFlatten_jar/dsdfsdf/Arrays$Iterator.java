public class Arrays$Iterator implements java.util.Iterator {
    final private Object[] dataArray;
    ...
    public Arrays$Iterator(Object[] arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public boolean hasNext() {/*error*/throw null;}
    ...
    public Object next() {/*error*/throw null;}
    
    
    public void remove() {
        throw new UnsupportedOperationException((String)None);
    }
}
