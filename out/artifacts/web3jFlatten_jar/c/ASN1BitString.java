abstract public class ASN1BitString extends ASN1Primitive {
    final private static char[] table;
    final byte[] data;
    final int padBits;
    ...
    ASN1BitString(byte[] arg, int arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private String getString() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private byte[] getBytes() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    int getPadBits() {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    protected boolean asn1Equals(ASN1Primitive arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    static byte[] derForm(byte[] arg, int arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    ASN1Primitive toDERObject() {/*error*/throw null;}
