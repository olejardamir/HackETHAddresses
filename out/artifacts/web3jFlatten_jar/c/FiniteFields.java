abstract class FiniteFields {
    final static PrimeField GF_2;
    final private static PrimeField GF_3;
    ...
    public static GenericPolynomialExtensionField getPrimeField(java.math.BigInteger arg) {/*error*/throw null;}
    
    
    static {
        GF_2 = new PrimeField(java.math.BigInteger.valueOf(2L));
        GF_3 = new PrimeField(java.math.BigInteger.valueOf(3L));
    }
}
