final class Strings {
    ...
    public static String toLowerCase(String arg) {/*error*/throw null;}
    
    
    public static String fromByteArray(byte[] a) {
        return new String(Strings.asCharArray(a));
    }
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private static char[] asCharArray(byte[] arg) {/*error*/throw null;}
}
