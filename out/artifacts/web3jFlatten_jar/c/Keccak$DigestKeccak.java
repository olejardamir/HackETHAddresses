public class Keccak$DigestKeccak extends BCMessageDigest implements Cloneable {
    Keccak$DigestKeccak() {
        super((ExtendedDigest)(Object)new KeccakDigest(256));
    }
    ...
    public byte[] engineDigest() {
        return ((BCMessageDigest)this).engineDigest();
    }
    
    public void engineUpdate(byte[] a, int i, int i0) {
        ((BCMessageDigest)this).engineUpdate(a, i, i0);
    }
    
    public void engineUpdate(byte a) {
        ((BCMessageDigest)this).engineUpdate(a);
    }
    
    public void engineReset() {
        ((BCMessageDigest)this).engineReset();
    }
}
