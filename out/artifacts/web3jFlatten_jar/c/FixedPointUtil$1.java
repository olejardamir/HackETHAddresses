final class FixedPointUtil$1 implements PreCompCallback {
    final ECCurve val$c;
    final ECPoint val$p;
    ...
    FixedPointUtil$1(ECCurve arg, ECPoint arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public PreCompInfo precompute(PreCompInfo arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private boolean checkExisting(FixedPointPreCompInfo arg, int arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    private boolean checkTable(ECLookupTable arg, int arg0) {/*error*/throw null;}
}
