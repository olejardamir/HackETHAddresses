class X9FieldElement {
    final private ECFieldElement f;
    final private static X9IntegerConverter converter;
    ...
    public X9FieldElement(ECFieldElement arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public ASN1Primitive toASN1Primitive() {/*error*/throw null;}
