abstract public class ECCurve$AbstractFp extends ECCurve {
    ECCurve$AbstractFp(java.math.BigInteger a) {
        super(FiniteFields.getPrimeField(a));
    }
    
    public ECCurve$AbstractFp() {
    }
    ...
    protected ECPoint decompressPoint(int arg, java.math.BigInteger arg0) {/*error*/throw null;}
}
