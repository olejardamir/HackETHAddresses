final class Arrays {
    ...
    public static boolean areEqual(byte[] arg, byte[] arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public static void fill(byte[] arg, byte arg0) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public static int hashCode(byte[] arg) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public static int hashCode(int[] arg, int arg0, int arg1) {/*error*/throw null;}
    ...
    // ClassLoaderError: 
    // ClassNotFoundException: java/lang/Throwable
    public static byte[] clone(byte[] arg) {/*error*/throw null;}
}
