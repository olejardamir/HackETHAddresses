class DERExternal extends ASN1External {
    public DERExternal(ASN1EncodableVector a) {
        super(a);
    }
    
    public DERExternal(ASN1ObjectIdentifier a, ASN1Integer a0, ASN1Primitive a1, DERTaggedObject a2) {
        this(a, a0, a1, a2.getTagNo(), a2.toASN1Primitive());
    }
    
    private DERExternal(ASN1ObjectIdentifier a, ASN1Integer a0, ASN1Primitive a1, int i, ASN1Primitive a2) {
        super(a, a0, a1, i, a2);
    }
    ...
    void encode(ASN1OutputStream arg) {/*error*/throw null;}
