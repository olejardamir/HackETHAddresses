...
class SecP256K1Field
{
    ...
    public static void squareN(int[] a, int i, int[] a0) {
		...
		int c1 = 0, w1, i2 = 7, j1 = 16;
		do {
			long xVal1 = (a[i2--] & 0xFFFFFFFFL), p1 = xVal1 * xVal1;
		...
		a1[0] = (int) p1;
		c1 = (int) (p1 >>> 32) & 1;
		long x_11 = a[1] & 0xFFFFFFFFL, zz_21 = a1[2] & 0xFFFFFFFFL;
		zz_15 += x_01 * x_11;
		w1 = (int) zz_15;
		a1[1] = c1 | w1 << 1;
		c1 = w1 >>> 31;
		zz_21 += zz_15 >>> 32;
		long x_21 = a[2] & 0xFFFFFFFFL, zz_31 = a1[3] & 0xFFFFFFFFL, zz_41 = a1[4] & 0xFFFFFFFFL;
		zz_21 += x_01 * x_21;
		w1 = (int) zz_21;
		a1[2] = c1 | w1 << 1;
		c1 = w1 >>> 31;
		...
		zz_41 += zz_31 >>> 32;
		zz_31 &= 0xFFFFFFFFL;
		long x_31 = a[3] & 0xFFFFFFFFL, zz_51 = (zz_41 >>> 32) + (a1[5] & 0xFFFFFFFFL);
		zz_41 &= 0xFFFFFFFFL;
		long zz_61 = (zz_51 >>> 32) + (a1[6] & 0xFFFFFFFFL);
		zz_51 &= 0xFFFFFFFFL;
		zz_31 += x_01 * x_31;
		w1 = (int) zz_31;
		a1[3] = c1 | w1 << 1;
		...
		zz_61 += zz_51 >>> 32;
		zz_51 &= 0xFFFFFFFFL;
		long x_41 = a[4] & 0xFFFFFFFFL, zz_71 = (zz_61 >>> 32) + (a1[7] & 0xFFFFFFFFL);
		zz_61 &= 0xFFFFFFFFL;
		long zz_81 = (zz_71 >>> 32) + (a1[8] & 0xFFFFFFFFL);
		zz_71 &= 0xFFFFFFFFL;
		zz_41 += x_01 * x_41;
		w1 = (int) zz_41;
		a1[4] = c1 | w1 << 1;
		...
		zz_81 += zz_71 >>> 32;
		zz_71 &= 0xFFFFFFFFL;
		long x_51 = a[5] & 0xFFFFFFFFL, zz_91 = (zz_81 >>> 32) + (a1[9] & 0xFFFFFFFFL);
		zz_81 &= 0xFFFFFFFFL;
		long zz_101 = (zz_91 >>> 32) + (a1[10] & 0xFFFFFFFFL);
		zz_91 &= 0xFFFFFFFFL;
		zz_51 += x_01 * x_51;
		w1 = (int) zz_51;
		a1[5] = c1 | w1 << 1;
		...
		zz_101 += zz_91 >>> 32;
		zz_91 &= 0xFFFFFFFFL;
		long x_61 = a[6] & 0xFFFFFFFFL, zz_111 = (zz_101 >>> 32) + (a1[11] & 0xFFFFFFFFL);
		zz_101 &= 0xFFFFFFFFL;
		long zz_121 = (zz_111 >>> 32) + (a1[12] & 0xFFFFFFFFL);
		zz_111 &= 0xFFFFFFFFL;
		zz_61 += x_01 * x_61;
		w1 = (int) zz_61;
		a1[6] = c1 | w1 << 1;
		...
		zz_121 += zz_111 >>> 32;
		zz_111 &= 0xFFFFFFFFL;
		long x_71 = a[7] & 0xFFFFFFFFL, zz_131 = (zz_121 >>> 32) + (a1[13] & 0xFFFFFFFFL);
		zz_121 &= 0xFFFFFFFFL;
		long zz_141 = (zz_131 >>> 32) + (a1[14] & 0xFFFFFFFFL);
		zz_131 &= 0xFFFFFFFFL;
		zz_71 += x_01 * x_71;
		w1 = (int) zz_71;
		a1[7] = c1 | w1 << 1;
		...
		while (true) {
			...
			int c = 0, w, i1 = 7, j = 16;
			do {
				long xVal = (a0[i1--] & 0xFFFFFFFFL), p = xVal * xVal;
				a1[--j] = (c << 31) | (int) (p >>> 33);
				a1[--j] = (int) (p >>> 1);
				c = (int) p;
			} while (i1 > 0);
			...
			a1[0] = (int) p;
			c = (int) (p >>> 32) & 1;
			long x_1 = a0[1] & 0xFFFFFFFFL, zz_2 = a1[2] & 0xFFFFFFFFL;
			zz_1 += x_0 * x_1;
			w = (int) zz_1;
			a1[1] = c | w << 1;
			c = w >>> 31;
			zz_2 += zz_1 >>> 32;
			long x_2 = a0[2] & 0xFFFFFFFFL, zz_3 = a1[3] & 0xFFFFFFFFL, zz_4 = a1[4] & 0xFFFFFFFFL;
			zz_2 += x_0 * x_2;
			w = (int) zz_2;
			a1[2] = c | w << 1;
			c = w >>> 31;
			...
			zz_4 += zz_3 >>> 32;
			zz_3 &= 0xFFFFFFFFL;
			long x_3 = a0[3] & 0xFFFFFFFFL, zz_5 = (zz_4 >>> 32) + (a1[5] & 0xFFFFFFFFL);
			zz_4 &= 0xFFFFFFFFL;
			...
			zz_6 += zz_5 >>> 32;
			zz_5 &= 0xFFFFFFFFL;
			long x_4 = a0[4] & 0xFFFFFFFFL, zz_7 = (zz_6 >>> 32) + (a1[7] & 0xFFFFFFFFL);
			zz_6 &= 0xFFFFFFFFL;
			...
			zz_8 += zz_7 >>> 32;
			zz_7 &= 0xFFFFFFFFL;
			long x_5 = a0[5] & 0xFFFFFFFFL, zz_9 = (zz_8 >>> 32) + (a1[9] & 0xFFFFFFFFL);
			zz_8 &= 0xFFFFFFFFL;
			...
			zz_10 += zz_9 >>> 32;
			zz_9 &= 0xFFFFFFFFL;
			long x_6 = a0[6] & 0xFFFFFFFFL, zz_11 = (zz_10 >>> 32) + (a1[11] & 0xFFFFFFFFL);
			zz_10 &= 0xFFFFFFFFL;
			...
			zz_12 += zz_11 >>> 32;
			zz_11 &= 0xFFFFFFFFL;
			long x_7 = a0[7] & 0xFFFFFFFFL, zz_13 = (zz_12 >>> 32) + (a1[13] & 0xFFFFFFFFL);
			zz_12 &= 0xFFFFFFFFL;
